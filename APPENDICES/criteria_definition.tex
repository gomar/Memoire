...
\begin{figure}[htp]
\centering
  \subfigure[$N=5$]{\includegraphics[width=.2\textwidth]{cut_plane_N05_adim.pdf}}\quad
  \subfigure[$N=10$]{\includegraphics[width=.2\textwidth]{cut_plane_N10_adim.pdf}}\quad
  \subfigure[$N=15$]{\includegraphics[width=.2\textwidth]{cut_plane_N15_adim.pdf}}
...
\begin{figure}[htp]
  \centering
  \includegraphics[width=.9\textwidth]{CRITERION_CROR.pdf}
