...
\begin{figure}[htbp]
  \centering
  \includegraphics*[scale=0.5]{timeline_hb_mono.pdf}
...
\citet{Jackson2011} \todo{bla bla bla}.
\citet{JSicot2012} \todo{bla bla bla}.
\citet{Mavriplis2012} \todo{bla bla bla}.
\citet{Thomas2013} \todo{blabla}.
\citet{JSicot2013} \todo{bla bla}.
\citet{Huang2013} \todo{bla bla bla + schéma}.
...
\begin{figure}[htbp]
  \centering
  \includegraphics*[scale=0.5]{timeline_hb_multi.pdf}
...
development of the multi-frequential Harmonic Balance method.