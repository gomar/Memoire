...
Nevertheless, the application of the multi-frequential
NonLinear Harmonic method to the Navier-Stokes
equations gives accurate results compared to classical 
time-marching approaches (see for instance ~\citet{Vilmin2006}).
\todo{est ce suffisant pour justifier cela??}
...
different clocking positions in a stator/rotor/stator configuration.
...
first clocking position provides a relatively low level of
unsteadiness to the
