...
Sec.~\ref{sub:sm_lur}.
In opposite, \citet{He1998} developed the method for the 
...
at the interface the perturbations are exchanged using
azimuthal Fourier transform for the perturbations and
...
\citet{Vilmin2013a} extended the computation of clocking effects to
arbitrary relative rotation speeds yielding the NLH rank$2$.
\todo{biblio He}
