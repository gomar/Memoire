...
\begin{figure}[htbp]
  ...
  \caption{Time line for the non-linear harmonic method. White and Black filled
...
They showed a good agreement with a classical non-linear
...
azimuthal Fourier transform. In opposite,
...
maturity of the method. They highlighted the effect of 
mesh refinement in combination with the NLH approach
and showed that approximately $40$ grid points are 
needed per wavelength to accurately capture them.
...
and applied it
on a $2$D $6.5$-stage compressor and on the Aachen $3$D $1.5$ 
stage axial turbine.
...
an impeller/bladed diffuser/volute radial compressor. No validation of 
these last computations is made against classical 
