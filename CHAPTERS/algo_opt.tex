%!TEX root = ../main.tex
\chapter{Improving the method} % (fold)
\label{cha:improving_the_method}

\lhead{Chapitre ??. \emph{Improving the method}}

\section{Algorithm to automatically choose the timelevels} % (fold)
...
\begin{figure}[htb]
  \centering 
    ...
    algorithms]{\includegraphics[width=.45\textwidth]{NONEQUI_BENCH_EQUI.eps}}
    \quad\subfigure[Proposed
    algorithms]{\includegraphics[width=.45\textwidth]{NONEQUI_BENCH_ALGO.eps}}
...
\begin{figure}[htb]
  ...
  $1/f_1$]{\includegraphics[width=.45\textwidth]{NONEQUI_TIMELEVELS_POSITION_F1.eps}}
  \quad\subfigure[Relative to period
  $1/f_2$]{\includegraphics[width=.45\textwidth]{NONEQUI_TIMELEVELS_POSITION_F2.eps}}
...
% section algorithm_to_automatically_choose_the_timelevels (end)

% chapter improving_the_method (end)