...
In total four spectral methods, the Linearized Unsteady Reynolds averaged
Navier-Stokes, the NonLinear Harmonic method, the NonLinear Frequency Domain
method and the Harmonic Balance method. These names are chosen here
...
\subsection{The Harmonic Balance method} % (fold)
