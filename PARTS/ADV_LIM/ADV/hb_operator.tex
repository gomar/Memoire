...
\begin{figure}[htb]
  \centering
  \subfigure[HB]{\includegraphics[width=.3\textwidth]{HB_OPERATOR_PPT_HB.pdf}}
  \subfigure[FD 2\textsuperscript{nd} order]{\includegraphics[width=.3\textwidth]{HB_OPERATOR_PPT_FD2.pdf}}
  \subfigure[FD 4\textsuperscript{th} order]{\includegraphics[width=.3\textwidth]{HB_OPERATOR_PPT_FD4.pdf}}
