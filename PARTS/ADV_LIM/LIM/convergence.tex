...
\begin{figure}[htbp]
  \centering
  \subfigure[$N=1$ computation]{\includegraphics[width=.35\textwidth]{convection_step_N1.pdf}}
  \subfigure[$N=2$ computation]{\includegraphics[width=.35\textwidth]{convection_step_N2.pdf}}
  \subfigure[$N=3$ computation]{\includegraphics[width=.35\textwidth]{convection_step_N3.pdf}}
  \subfigure[$N=4$ computation]{\includegraphics[width=.35\textwidth]{convection_step_N4.pdf}}
  \subfigure[$N=5$ computation]{\includegraphics[width=.35\textwidth]{convection_step_N5.pdf}}
  \subfigure[$N=6$ computation]{\includegraphics[width=.35\textwidth]{convection_step_N6.pdf}}
...
\begin{figure}[htbp]
  \centering
  \subfigure[$N=1$ computation]{\includegraphics[width=.35\textwidth]{convection_wake_N1.pdf}}
  \subfigure[$N=2$ computation]{\includegraphics[width=.35\textwidth]{convection_wake_N2.pdf}}
  \subfigure[$N=3$ computation]{\includegraphics[width=.35\textwidth]{convection_wake_N3.pdf}}
  \subfigure[$N=4$ computation]{\includegraphics[width=.35\textwidth]{convection_wake_N4.pdf}}
  \subfigure[$N=5$ computation]{\includegraphics[width=.35\textwidth]{convection_wake_N5.pdf}}
  \subfigure[$N=6$ computation]{\includegraphics[width=.35\textwidth]{convection_wake_N6.pdf}}
  \caption{Harmonic balance results for 
