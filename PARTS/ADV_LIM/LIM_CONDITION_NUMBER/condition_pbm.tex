...
of the linear advection equation problem presented in Sec.~\ref{sec:linear}:
\begin{equation}
...
we consider an unsteady channel flow with 
oscillating back-pressure described in 
...
Similar difficulties have been found in the literature.
