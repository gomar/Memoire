...
by using evenly-spaced time instances.
...
\begin{figure}[htp]
  \centering
  \subfigure[$a_1 = 0.01$]{\includegraphics[width=.4\textwidth]{CANAL2_RESIDUAL_VS_CONDITIONNING_AMP001_PPT.pdf}}
  \subfigure[$a_1 = 0.05$]{\includegraphics[width=.4\textwidth]{CANAL2_RESIDUAL_VS_CONDITIONNING_AMP005_PPT.pdf}}
