...
\begin{figure}[htp]
  \centering 
    \subfigure[EVE $(2N + 1)$]{\includegraphics[width=.4\textwidth]{algo_equi_assessment.pdf}}
    \subfigure[EVE $(3N + 1)$]{\includegraphics[width=.4\textwidth]{algo_equi_3n_assessment.pdf}}
    \subfigure[APFT]{\includegraphics[width=.4\textwidth]{algo_apft_assessment.pdf}}
    \subfigure[OPT]{\includegraphics[width=.4\textwidth]{algo_opt_assessment.pdf}}
...
time instances for the fundamental frequency are still seen 
...
Baring in mind that if each frequency sees evenly-spaced time instances,
...
\begin{figure}[htp]
  ...
  \subfigure[relative to period $1/f_1$]{
      \includegraphics[width=.4\textwidth]{timelevels_distribution_f1.pdf}}
  \subfigure[relative to period $1/f_2$]{
      \includegraphics[width=.4\textwidth]{timelevels_distribution_f2.pdf}}
