...
\mytodo{rappeler objectif: minimiser K avec comme contrainte le sampling the f1 et f2}
...
are too close to one another ($f_1=f_2$) or when they are significantly
