...
Originally, this study was conducted to understand the convergence
issues observed on Contra-Rotating Open Rotors (CROR) configurations.
...
\begin{figure}[htb]
  \centering
  \subfigure[$N=1$]{\includegraphics[width=.2\textwidth]{dream_LS_N01_entropy_75.jpg}}
  \subfigure[$N=2$]{\includegraphics[width=.2\textwidth]{dream_LS_N02_entropy_75.jpg}}
  \subfigure[$N=3$]{\includegraphics[width=.2\textwidth]{dream_LS_N03_entropy_75.jpg}}
  \subfigure[$N=4$]{\includegraphics[width=.2\textwidth]{dream_LS_N04_entropy_75.jpg}}
  \subfigure[$N=5$]{\includegraphics[width=.2\textwidth]{dream_LS_N05_entropy_75.jpg}}
  \subfigure[$N=6$]{\includegraphics[width=.2\textwidth]{dream_LS_N06_entropy_75.jpg}}
...
negligible for a finner sampling. The main difference with the \mockup-LS
...
\begin{figure}[htb]
  \centering
  \subfigure[$N=1$]{\includegraphics[width=.2\textwidth]{dream_HS_N01_entropy_75.jpg}}
  \subfigure[$N=2$]{\includegraphics[width=.2\textwidth]{dream_HS_N02_entropy_75.jpg}}
  \subfigure[$N=3$]{\includegraphics[width=.2\textwidth]{dream_HS_N03_entropy_75.jpg}}
  \subfigure[$N=4$]{\includegraphics[width=.2\textwidth]{dream_HS_N04_entropy_75.jpg}}
  \subfigure[$N=5$]{\includegraphics[width=.2\textwidth]{dream_HS_N05_entropy_75.jpg}}
  \subfigure[$N=6$]{\includegraphics[width=.2\textwidth]{dream_HS_N06_entropy_75.jpg}}
  \subfigure[$N=7$]{\includegraphics[width=.2\textwidth]{dream_HS_N07_entropy_75.jpg}}
  \subfigure[$N=8$]{\includegraphics[width=.2\textwidth]{dream_HS_N08_entropy_75.jpg}}
  \subfigure[$N=9$]{\includegraphics[width=.2\textwidth]{dream_HS_N09_entropy_75.jpg}}
...
\begin{figure}[htb]
  \centering
  \subfigure[$N=1$]{\includegraphics[width=.2\textwidth]{aipx7_N01_entropy_75.jpg}}
  \subfigure[$N=2$]{\includegraphics[width=.2\textwidth]{aipx7_N02_entropy_75.jpg}}
  \subfigure[$N=3$]{\includegraphics[width=.2\textwidth]{aipx7_N03_entropy_75.jpg}}
  \subfigure[$N=4$]{\includegraphics[width=.2\textwidth]{aipx7_N04_entropy_75.jpg}}
  \subfigure[$N=5$]{\includegraphics[width=.2\textwidth]{aipx7_N05_entropy_75.jpg}}
  \subfigure[$N=6$]{\includegraphics[width=.2\textwidth]{aipx7_N06_entropy_75.jpg}}
  \subfigure[$N=7$]{\includegraphics[width=.2\textwidth]{aipx7_N07_entropy_75.jpg}}
  \subfigure[$N=8$]{\includegraphics[width=.2\textwidth]{aipx7_N08_entropy_75.jpg}}
  \subfigure[$N=9$]{\includegraphics[width=.2\textwidth]{aipx7_N09_entropy_75.jpg}}
  \subfigure[$N=10$]{\includegraphics[width=.2\textwidth]{aipx7_N10_entropy_75.jpg}}
...
The results are in good agreement with the prediction tool
based on the wake thickness. To emphasis that, the number of harmonics
...
The restitution time needed to
...
\begin{figure}[htb]
  \centering
  \subfigure[\mockup-LS]{\includegraphics[width=.32\textwidth]{dream_ls.png}}
  \subfigure[\mockup-HS]{\includegraphics[width=.32\textwidth]{dream_hs_roe2.png}}
  \subfigure[\aipx-HS]{\includegraphics[width=.32\textwidth]{aipx7_hs.png}}
