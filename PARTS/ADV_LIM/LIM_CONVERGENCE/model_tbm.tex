...
Several wake thicknesses will be tested bellow
...
in the spatial spectra as shown in Figure~\ref{fig:spatial_crit}
for $N=2$ to $N=10$.
...
\begin{figure}[htp]
  \begin{center}
  \subfigure[$L=10\%$, $N=3$]{
    \includegraphics[width=.35\textwidth]{PB_FFT_AZI_10_3}\label{fig:ST_discrepancies_a}}
  \subfigure[$L=25\%$, $N=15$]{
    \includegraphics[width=.35\textwidth]{PB_FFT_AZI_25_15}\label{fig:ST_discrepancies_b}}
  \end{center}
...
\begin{figure}[htp]
  \centering
  \subfigure[signal ($\Delta \theta = L$)]{\includegraphics[width=.35\textwidth]{PB_FFT_AZI_DEMO_1_1}}
  \subfigure[Fourier transform ($\Delta \theta = L$)]{\includegraphics[width=.35\textwidth]{PB_FFT_AZI_DEMO_1_2}}
  \subfigure[signal ($\Delta \theta = 10L$)]{\includegraphics[width=.35\textwidth]{PB_FFT_AZI_DEMO_10_1}}
  \subfigure[Fourier transform ($\Delta \theta = 10L$)]{\includegraphics[width=.35\textwidth]{PB_FFT_AZI_DEMO_10_2}}
  \subfigure[signal ($\Delta \theta = 100L$)]{\includegraphics[width=.35\textwidth]{PB_FFT_AZI_DEMO_100_1}}
  \subfigure[Fourier transform ($\Delta \theta = 100L$)]{\includegraphics[width=.35\textwidth]{PB_FFT_AZI_DEMO_100_2}}
...
\centering
  \subfigure[$N=5$]{
  \includegraphics[width=.35\textwidth]{interp_wake_W0490_TSM_N005.pdf}
  \label{fig:temp_signal_a}}
  \subfigure[$N=10$]{
  \includegraphics[width=.35\textwidth]{interp_wake_W0490_TSM_N010.pdf}}
  \subfigure[$N=15$]{
  \includegraphics[width=.35\textwidth]{interp_wake_W0490_TSM_N015.pdf}
...
\begin{figure}[htp]
\centering
\subfigure[$N=2$]{\includegraphics[width=.35\textwidth]{SpcTme_Dualite_0490_02.pdf}}
\subfigure[$N=5$]{\includegraphics[width=.35\textwidth]{SpcTme_Dualite_0490_05.pdf}}
\subfigure[$N=10$]{\includegraphics[width=.35\textwidth]{SpcTme_Dualite_0490_10.pdf}}
\subfigure[$N=20$]{\includegraphics[width=.35\textwidth]{SpcTme_Dualite_0490_20.pdf}}
...
\begin{figure}[htp]
  \centering
  \subfigure[$L = 2 \%$]{\includegraphics[width=.35\textwidth]{RB_MP_0200_error_logY.pdf}}\quad
  \subfigure[$L = 5 \%$]{\includegraphics[width=.35\textwidth]{RB_MP_0490_error_logY.pdf}}\quad
  \subfigure[$L = 10 \%$]{\includegraphics[width=.35\textwidth]{RB_MP_0965_error_logY.pdf}}\quad
  \subfigure[$L = 15 \%$]{\includegraphics[width=.35\textwidth]{RB_MP_1520_error_logY.pdf}}\quad
