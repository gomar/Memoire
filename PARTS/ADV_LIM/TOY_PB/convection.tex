...
\begin{itemize} \itemsep0pt \parskip0pt
  \item highlight the advantage of Fourier-based time methods for a harmonic
  signal (Sec.~\ref{sec:sum_sine}) and for a segregated harmonic signal
  (Sec.~\ref{sec:adv_multifreq}),
  \item show their limit in terms of condition number (Sec.~\ref{sec:condition_pbm})
  and convergence of the computations (Sec.~\ref{sec:convergence_advection}).
\end{itemize}
