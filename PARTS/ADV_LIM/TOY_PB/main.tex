...
balance method in a non-linear equation framework. Furthermore, 
the solver used for this last case is the \emph{elsA}
code which is used for the CROR applications. Therefore, the
properties derived in this part of the thesis can be extended
to the final application part.}
