...
in Fig.~\ref{fig:conv_sum_sine}. Two results are displayed:
...
as indicated by Fig.~\ref{fig:conv_sum_sine}
...
is shown in Fig.~\ref{fig:conv_multifreq_tsm} for the
...
as shown in Fig.~\ref{fig:convection_multifreq_tsm_N5}.
