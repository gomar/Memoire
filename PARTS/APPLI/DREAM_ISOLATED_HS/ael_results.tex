...
\begin{figure}[htp]
  \centering
  \subfigure[2F mode]{\includegraphics[width=.4\textwidth]{DREAM_HS_DAMPING_MODE_2F.pdf}}
  \subfigure[1T mode]{\includegraphics[width=.4\textwidth]{DREAM_HS_DAMPING_MODE_1T.pdf}}
...
\begin{figure}[htp]
 ...
 \begin{tabular}{r|cccc}
   ...
   \multicolumn{1}{c}{} & \multicolumn{4}{c}{
        \includegraphics[width=.4\textwidth]{DREAM_HS_COMVERGENCE_DAMPING.pdf}} \\
 \end{tabular}
