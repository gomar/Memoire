...
\begin{figure}[htp]
  \centering
  \subfigure[2F mode]{\includegraphics[width=0.45\textwidth]{DREAM_HS_DAMPING_MODE_2F.pdf}}
  \subfigure[1T mode]{\includegraphics[width=0.45\textwidth]{DREAM_HS_DAMPING_MODE_1T.pdf}}
...
\begin{figure}[htp]
 ...
 \begin{tabular}{r|cccc}
   \toprule
   & \multicolumn{4}{c}{
        \includegraphics[width=0.35\textwidth]{dream_hs_damping_scale.pdf}} \\
...
So far, all aeroelastic simulations have been carried
out by using five harmonics. \added{However, the \emph{a priori}
estimator predicts that $N=7$ harmonics are required to
converge the unsteady aerodynamic of the currently studied
high-speed configuration 
(see Sec.~\ref{sub:dream_hs_conv_hb_prediction_tool}). This means that the high-speed
aeroelastic computations might be under-resolved in terms of
aerodynamic frequencies as only five frequencies are used in total. 
Therefore,}
