...
\begin{figure}[htp]
  \centering
  \subfigure[front rotor]{\includegraphics[width=0.45\textwidth]{DREAM_HS_TSM_FORCES_INST_FRONT_PPT.pdf}}
  \subfigure[rear rotor]{\includegraphics[width=0.45\textwidth]{DREAM_HS_TSM_FORCES_INST_REAR_PPT.pdf}}
...
% \begin{figure}[htp]
%   \centering
%   \includegraphics*[width=0.45\textwidth]{DREAM_HS_TSM_N7_roe2_sa_slice_r_70_ps.png}
...
% \begin{figure}[htp]
%   \centering
%   \includegraphics*[width=0.45\textwidth]{DREAM_HS_TSM_N7_roe2_sa_slice_r_70_machrel.png}
%   \caption{High-speed isolated configuration: radial cut of the first harmonic of the
