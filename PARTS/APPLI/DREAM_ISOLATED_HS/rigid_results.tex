...
\begin{figure}[htp]
  \centering
  \subfigure[front rotor]{\includegraphics[width=.45\textwidth]{DREAM_HS_TSM_FORCES_INST_FRONT_PPT.pdf}}
  \subfigure[rear rotor]{\includegraphics[width=.45\textwidth]{DREAM_HS_TSM_FORCES_INST_REAR_PPT.pdf}}
