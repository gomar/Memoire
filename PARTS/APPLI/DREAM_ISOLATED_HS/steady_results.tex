...
\begin{figure}[htp]
  \centering
  \subfigure[residuals]{\includegraphics[width=0.45\textwidth]{DREAM_HS_RESIDUALS_PPT.pdf}}
  \subfigure[thrust coefficient]{\includegraphics[width=0.45\textwidth]{DREAM_HS_FORCES_CT_PPT.pdf}}
  \subfigure[power coefficient]{\includegraphics[width=0.45\textwidth]{DREAM_HS_FORCES_CP_PPT.pdf}}
  \subfigure[efficiency]{\includegraphics[width=0.45\textwidth]{DREAM_HS_FORCES_ETA_PPT.pdf}}
...
\begin{figure}[htp]
  ...
  \subfigure[absolute Mach number]{
    ...
    \includegraphics[width=.78\textwidth]{DREAM_HS_RANS_AZI_MEAN_PPT_macha.pdf}}
  \subfigure[absolute flow angle]{
    \label{fig:dream_HS_radial_profiles_alpha}
    \includegraphics[width=.78\textwidth]{DREAM_HS_RANS_AZI_MEAN_PPT_alpha.pdf}}
...
\begin{figure}[htp]
  ...
  \subfigure[static pressure]{
    ...
    \includegraphics[width=.78\textwidth]{DREAM_HS_RANS_AZI_MEAN_PPT_ps.pdf}}
  \subfigure[stagnation temperature]{
    \label{fig:dream_HS_radial_profiles_ti}
    \includegraphics[width=.78\textwidth]{DREAM_HS_RANS_AZI_MEAN_PPT_ti.pdf}}
  \subfigure[stagnation pressure]{
    \label{fig:dream_HS_radial_profiles_pi}
    \includegraphics[width=.78\textwidth]{DREAM_HS_RANS_AZI_MEAN_PPT_pi.pdf}}
