...
plot 'space_scheme_diff.dat' i 0 u ($0):($7/1.4301):(bs) t 'Roe 1'  w boxes ls 1, \
     ...
     ''                      i 2 u ($0+2*bs):($7/1.4301):(bs):xticlabels('$C_T$') t 'Roe 3' w boxes ls 3, \
     ...
     ''                      i 2 u (1+$0+2*bs):($8/2.8554):(bs):xticlabels('$C_P$') notitle w boxes ls 3, \
     ...
     ''                      i 2 u (2+$0+2*bs):($9/0.5659):(bs):xticlabels('$\eta$') notitle w boxes ls 3, \
