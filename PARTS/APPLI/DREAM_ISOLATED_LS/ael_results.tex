...
\begin{figure}[htp]
  \centering
  \subfigure[mode 2F]{\includegraphics[width=.4\textwidth]{DREAM_LS_DAMPING_MODE_2F.pdf}}
  \subfigure[mode 1T]{\includegraphics[width=.4\textwidth]{DREAM_LS_DAMPING_MODE_1T.pdf}}
