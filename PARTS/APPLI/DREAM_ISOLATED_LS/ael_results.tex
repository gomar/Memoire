...
Thirdly, obviously, inflexion lines
for the modes are also inflexion lines for the damping
value. Other inflexion lines are seen for the damping values.
...
\begin{figure}[htp]
 ...
 \begin{tabular}{r|cccc}
   ...
   & \emph{suction side} & \emph{pressure side} & \emph{suction side} & \emph{pressure side} \\
   \bottomrule
 \end{tabular}
