...
\begin{figure}[htp]
  \centering
  \subfigure[2F mode]{\includegraphics[width=0.45\textwidth]{DREAM_LS_DAMPING_MODE_2F.pdf}}
  \subfigure[1T mode]{\includegraphics[width=0.45\textwidth]{DREAM_LS_DAMPING_MODE_1T.pdf}}
...
\begin{figure}[htp]
 ...
 \begin{tabular}{r|cccc}
   \toprule
   & \multicolumn{4}{c}{
        \includegraphics[width=0.35\textwidth]{dream_ls_damping_scale.pdf}} \\
