...
\begin{figure}[htp]
  \centering
  \subfigure[2F mode]{\includegraphics[width=.4\textwidth]{DREAM_LS_DAMPING_MODE_2F.pdf}}
  \subfigure[1T mode]{\includegraphics[width=.4\textwidth]{DREAM_LS_DAMPING_MODE_1T.pdf}}
