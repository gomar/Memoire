...
The ratio \deleted{of the frequency} of the blade passing 
frequency of the opposite row, namely the rear rotor,
over the aeroelastic frequency of
each mode varies \replaced{within the range}{between}
$3.19 \leq f_{BPF} / f_{AEL} \leq 3.87$
\added{, and yields therefore non-harmonically related
frequencies}. However,
