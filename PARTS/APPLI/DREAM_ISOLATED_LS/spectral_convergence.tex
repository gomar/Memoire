...
The entropy spurious waves are completely gone for the $N=4$ computation even though
the HB $N=3$ computation give a smooth entropy field.
\begin{figure}[htp]
  \centering
  \subfigure[HB $N=1$]{
...
\end{figure}
Therefore, for the following results, the HB $N=4$ will be chosen as the 
reference one to analyze the results of the unsteady rigid simulations.
