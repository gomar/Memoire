...
\begin{figure}[htp]
  \centering
  \subfigure[residuals]{\includegraphics[width=.45\textwidth]{DREAM_LS_RESIDUALS_PPT.pdf}}
  \subfigure[thrust coefficient]{\includegraphics[width=.45\textwidth]{DREAM_LS_FORCES_CT_PPT.pdf}}
  \subfigure[power coefficient]{\includegraphics[width=.45\textwidth]{DREAM_LS_FORCES_CP_PPT.pdf}}
  \subfigure[efficiency]{\includegraphics[width=.45\textwidth]{DREAM_LS_FORCES_ETA_PPT.pdf}}
