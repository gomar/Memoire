...
The second rotor allows thus to more than double 
the total thrust of the engine which is consistent. 
Achieving such a level of thrust coefficient ($C_T = 1.1319$)
with an isolated
