...
\added{The} convergence of the steady computation using the Roe~2 space scheme
...
\begin{figure}[htp]
  \centering
  \subfigure[residuals]{\includegraphics[width=0.45\textwidth]{DREAM_LS_RESIDUALS_PPT.pdf}}
  \subfigure[thrust coefficient]{\includegraphics[width=0.45\textwidth]{DREAM_LS_FORCES_CT_PPT.pdf}}
  \subfigure[power coefficient]{\includegraphics[width=0.45\textwidth]{DREAM_LS_FORCES_CP_PPT.pdf}}
  \subfigure[efficiency]{\includegraphics[width=0.45\textwidth]{DREAM_LS_FORCES_ETA_PPT.pdf}}
...
up to $M=0.4$. Note that above $R/R_f=1$, namely \replaced{above}{at} the tip
...
\begin{figure}[htp]
  ...
  \subfigure[position of the extraction planes]{
    ...
    \includegraphics[width=.65\textwidth]{dream_position_azi_mean.pdf}}
  \subfigure[absolute Mach number]{
    \label{fig:dream_ls_radial_profiles_ma}
    \includegraphics[width=.78\textwidth]{DREAM_LS_RANS_AZI_MEAN_PPT_macha.pdf}}
  \subfigure[absolute flow angle]{
    \label{fig:dream_ls_radial_profiles_alpha}
    \includegraphics[width=.78\textwidth]{DREAM_LS_RANS_AZI_MEAN_PPT_alpha.pdf}}
...
\begin{figure}[htp]
  ...
  \subfigure[static pressure]{
    ...
    \includegraphics[width=.78\textwidth]{DREAM_LS_RANS_AZI_MEAN_PPT_ps.pdf}}
  \subfigure[stagnation temperature]{
    \label{fig:dream_ls_radial_profiles_ti}
    \includegraphics[width=.78\textwidth]{DREAM_LS_RANS_AZI_MEAN_PPT_ti.pdf}}
  \subfigure[stagnation pressure]{
    \label{fig:dream_ls_radial_profiles_pi}
    \includegraphics[width=.78\textwidth]{DREAM_LS_RANS_AZI_MEAN_PPT_pi.pdf}}
...
presented here. This is emphasized by the $P4$ axial cut of entropy \replaced{as a}{. A}
