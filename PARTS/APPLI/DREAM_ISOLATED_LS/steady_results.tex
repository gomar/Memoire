...
\begin{table}[htb]
  ...
  \begin{tabular}{ccc|cccccc}
    ...
    \midrule
    1.4301 & 2.8554 &  0.5659 & 0.5637 & 0.9941 &  0.6002 & 0.8664 & 1.8613 &  0.5475 \\
    \bottomrule
  \end{tabular}
...
rotor is able to retrieve a thrust coefficient of $0.8664$ while
...
it goes from $0.6002$ for the front rotor to $0.5659$ for the CROR.
...
Tab.~\ref{tab:dream_ls_sim_coeff}.
