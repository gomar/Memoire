...
\begin{figure}[htp]
  \centering
  \subfigure[amplitude]{
  \includegraphics[width=.45\textwidth]{STCF11_AEL_SUBSONIC_IBPA_180_Cp_PPT.pdf}}
  \subfigure[phase]{
  \includegraphics[width=.45\textwidth]{STCF11_AEL_SUBSONIC_IBPA_180_Phi_PPT.pdf}}
...
The results for the  nodal  diameter $-2$, corresponding to $\text{IBPA}=-36^\circ$, namely
...
\begin{figure}[htp]
  \centering
  \subfigure[amplitude]{
  \includegraphics[width=.45\textwidth]{STCF11_AEL_SUBSONIC_IBPA_324_Cp_PPT.pdf}}
  \subfigure[phase]{
  \includegraphics[width=.45\textwidth]{STCF11_AEL_SUBSONIC_IBPA_324_Phi_PPT.pdf}}
...
\begin{figure}[htp]
  \centering
  \includegraphics[width=.45\linewidth]{STCF11_SUBSONIC_DAMPING_PPT.pdf}
