...
a small separation
bubble develops on the suction side at the leading edge~(cf.~Fig.~\ref{fig:stcf11_rans_transonic}).  
...
\begin{figure}[htb]
  ...
  \subfigure[Contours]{
  \includegraphics[height=.3\textwidth]{stcf11_transonic.png}}
  \caption{Steady results of the isentropic Mach number, transonic case.}
...
\begin{figure}[htb]
  \centering
  \subfigure[Amplitude]{
  \includegraphics[width=.4\textwidth]{STCF11_AEL_TRANSONIC_IBPA_180_Cp_ppt.pdf}}
  \subfigure[Phase]{
  \includegraphics[width=.4\textwidth]{STCF11_AEL_TRANSONIC_IBPA_180_Phi_ppt.pdf}}
...
\begin{figure}[htb]
  \centering
  \subfigure[Amplitude]{
  \includegraphics[width=.4\textwidth]{STCF11_AEL_TRANSONIC_IBPA_324_Cp_ppt.pdf}}
  \subfigure[Phase]{
  \includegraphics[width=.4\textwidth]{STCF11_AEL_TRANSONIC_IBPA_324_Phi_ppt.pdf}}
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=.46\linewidth]{STCF11_TRANSONIC_DAMPING_PPT.pdf}
