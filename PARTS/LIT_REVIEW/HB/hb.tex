...
used as detailed by \citet{ThesisGuedeney}.}
...
\replaced{In this work, we will consider as base frequences both the one
...
we assume that combinaitions of the frequencies will be less
energetic than the aerodynamic and aeroelastic frequencies.
...
\added{This can be the case of an airplane in climb or 
landing where the engines experience a physical transient.}
