...
A pylon/rotor/rotor configuration shown in Fig.~\ref{hera3_geometry}
...
on the all span. The span being given relative to the front
...
calculs twin + wavelet basis + optimization + convergence sur cas AEL + ael rear rotor

\begin{figure}[htp]
  \centering
  \subfigure[geometry]{
  	\label{hera3_geometry}
  	\includegraphics[width=.4\textwidth]{HERA3_INSTALLED_wall.png}}
  \subfigure[prediction tool]{
  	\label{hera3_perspectives}
