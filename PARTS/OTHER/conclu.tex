...
% In the context of air traffic growth and global warming,
% new concepts are needed for both the engines and the 
% aircraft in general, to allow a sustainable air transportation.
% One concept is the contra-rotating open rotor
% that relies on two rows of contra-rotating propellers
% that proves its viability during experiments within the framework of
% the previously mentioned Advanced 
% Turboprop project of NASA~\cite{Hager1988}.
% However, 
...
In this work, the multi-frequential
