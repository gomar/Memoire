...
The HB method along with a decoupled approach
...
the proposed decoupled approach along with
...
Aeroelastic simulations are then launched using the decoupled
...
\begin{figure}[htp]
  ...
  \subfigure[prediction tool]{
  	...
  	\includegraphics[width=.4\textwidth]{HERA3_INSTALLED_RANS_SPECTRUM_PPT.pdf}}
...
proposed approach is decoupled meaning
