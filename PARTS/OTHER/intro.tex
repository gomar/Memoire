...
\begin{itemize}
	...
	namely the multi-frequential harmonic balance method along with a 
	\replaced{decoupled}{weak-coupling} aeroelastic approach, is applied on different configurations
