...
but involves higher noise emissions due to the absence of
...
This is why, a second approach 
is to work on the time-integration algorithm to reduce
the computational cost compared to standard time-marching techniques. 
To achieve
