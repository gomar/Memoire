...
% \citet{Clark2004} classifies the aerodynamic
% mechanism responsible for flutter in a turbomachinery operating map.
% This is reproduced in Fig.~\ref{fig:flutter_types}.
% Five regions are identified: I)~\mbox{subsonic/stalled} flutter
% and system mode instability, 
% II)~system mode instability, III)

% \begin{figure}[htbp]
%   \centering
%   \includegraphics*[width=0.40\textwidth]{flutter_types.pdf}
%   \caption{caption}
%   \label{fig:flutter_types}
% \end{figure}
