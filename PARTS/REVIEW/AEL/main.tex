...
approach retained to simulate it, namely the decoupled approach,
...
the strong-coupling and the decoupled one. Even though
...
formula to compute the damping within the decoupled
...
open rotors within the decoupled
approach.}
