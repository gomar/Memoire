...
approach retained to simulate it, namely the weak-coupling approach,
...
the opposite rotor. The study of the structural 
response to the unsteady flow field is called dynamic
aeroelasticity. Two approaches exists to simulate such a phenomenon:
the strong-coupling and the weak-coupling. Even though
strong-coupling remains more accurate, the cost
of such an approach prevents its use in the industry.
Therefore, the weak-coupling approach is the method 
