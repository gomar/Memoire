...
analyze the unsteady flow physics that develop on given design.
...
developed an efficient CFD approach to simulate the aeroacoustic of CRORs.
...
discuss the simulation tools needed to compute such a phenomena as
