...
In aviation, lift balances weight and 
thrust balances drag. This explains why engineer try
...
away from the engine so that $\vec{\vec{\Sigma}}_v$ becomes zero (\emph{e.g.}
...
Doing so while maintaining the thrust can be achieve through
