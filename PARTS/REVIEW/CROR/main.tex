...
and propulsive efficiency equations. Using these,
the propeller engines are shown to be good candidates
for efficient alternative engines, mainly due to its high bypass ratio.
The geometry, general principles, similarity coefficients
