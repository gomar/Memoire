...
\mytodo{Guillaume: partie un peu abrupte. Problematique pas posee, diff entre
ekici et gopinath pas mis en valeur. Pourquoi transformee Fourier en theta ?
se positionner par rapport au multi choro de maniere generale}
...
\citet{JSicot2012} implemented the harmonic balance 
into the \emph{elsA} CFD flow solver (Appendix~\ref{app:elsa})
