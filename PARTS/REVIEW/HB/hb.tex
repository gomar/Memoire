...
the "rectangular grid" and the "diamond grid" truncations.
...
\begin{figure}[htp]
  \centering
  \subfigure[rectangular grid]{\includegraphics[width=.25\textwidth]{truncation_square.pdf}}
...
rectangular grid pattern. In his PhD thesis, \citet{ThesisGuedeney}
...
However, for the same reasons as detailed in Sec.~\ref{par:gradient_nlfd},
