...
There is a large variety of Fourier-based methods in the
literature. 
...
overview of the types of Fourier-based methods in the literature
and their differences.

As the development of these approaches for the Navier--Stokes equations
