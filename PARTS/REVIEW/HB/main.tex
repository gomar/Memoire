...
the method to the multi-frequential framework.}
...
In particular, the harmonic balance method, that will be used
in the current work, can
...
unsteady applications. Moreover, the method is shown to be adapted to
the computation of aeroelastic phenomenon on 
