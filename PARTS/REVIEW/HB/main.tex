...
\section{Periodic flows in turbomachineries}
\label{sec:sm_hudson}
...
Before applying the HB method to CROR, we investigate these aspects 
in the next chapter and suggest possible solutions.}
