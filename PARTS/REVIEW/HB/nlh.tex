...
gives $2N$ perturbation equations and one time-averaged 
equation making $2N+1$ equations in total. 
...
the temporal mean value is shown to exists. It is defined as
\begin{equation}
