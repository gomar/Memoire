...
\mytodo{Guillaume releve que comme on est en frequency domain,
forcement l equation ne depend pas du temps}
...
convergence of Fourier-based time methods will be introduced 
...
\mytodo{Guillaume: un peu rapide la. Mettre peut etre un exemple
en prenant une frequnce pi et 2}
...
since five equations are solved using the NLH approach and 
the turbulent equation
